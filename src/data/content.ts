  ...
  NAV: [
    { label: 'Home', href: '#home' },
    {
      ...
      children: [
        ...
        { label: 'Deities at the Temple', href: '/deities' },
        { label: 'Miracles of Sri Vakrathunda Vinayagar', href: '/miracles' },
        ...
        { label: "The Southern Hemisphere's first Granite Temple", href: '/granite-shrine' },
        { label: 'Temple Opening Hours', href: '/opening-hours' },
      ],
    },
    {
      label: 'Services',
      href: '/services',
      children: [
        { label: 'Pooja Service', href: '/pooja-service' },
        { label: 'Wedding Services', href: '/wedding-services' },
        { label: 'Yearly Pooja Bookings & Availability', href: '/pooja-bookings' },
    ...
    },
    {
      ...
      href: '/canteen',
      children: [
        { label: 'Canteen Menu', href: '/canteen-menu' },
        { label: 'Opening hours', href: '/canteen' },
        { label: 'Catering (Internal and External)', href: '/catering' },
      ],
    },
    {
      label: 'Events',
      href: '/events',
      children: [{ label: 'Community Events', href: '/community-events' }],
    },
  ...
  NAV: [
    { label: 'முகப்பு', href: '#home' },
    {
      ...
      children: [
        ...
        { label: 'கோயில் மூர்த்திகள்', href: '/deities' },
        { label: 'ஸ்ரீ வக்ரதுண்ட விநாயகரின் அற்புதங்கள்', href: '/miracles' },
        { label: 'சமூக மையம்', href: '/community-hub' },
        { label: 'அறங்காவலர் குழு', href: '/trustees' },
        { label: 'நிர்வாகக் குழு', href: '/management-team' },
        { label: 'அர்ச்சகர்கள்', href: '/priests' },
        { label: 'கோயில் பணியாளர்கள்', href: '/temple-staff' },
        { label: 'ஊடகம்', href: '/media' },
        { label: 'தென் அரைக்கோளத்தின் முதல் கருங்கல் கோயில்', href: '/granite-shrine' },
        { label: 'கோயில் திறக்கும் நேரம்', href: '/opening-hours' },
      ],
    },
    {
      label: 'சேவைகள்',
      href: '/services',
      children: [
        { label: 'பூஜை சேவை', href: '/pooja-service' },
        { label: 'திருமண சேவைகள்', href: '/wedding-services' },
        { label: 'வருடாந்திர பூஜை முன்பதிவு & கிடைப்பு', href: '/pooja-bookings' },
        { label: 'சமூக சேவைகள்', href: '/community-services' },
      ],
    },
    {
      label: 'கணேஷா உணவகம்',
      href: '/canteen',
      children: [
        { label: 'உணவக பட்டியல்', href: '/canteen-menu' },
        { label: 'திறக்கும் நேரம்', href: '/canteen' },
        { label: 'கேட்டரிங் (உள் & வெளி)', href: '/catering' },
      ],
    },
    {
      label: 'நிகழ்வுகள்',
      href: '/events',
      children: [{ label: 'சமூக நிகழ்வுகள்', href: '/community-events' }],
    },
    { label: 'மின்-நாட்காட்டி', href: '/e-calendar' },
    { label: 'நன்கொடை', href: '/how-to-donate' },
    {
      label: 'இணையுங்கள்',
      href: '/join-us',
      children: [
        { label: 'உறுப்பினராகுங்கள்', href: '/become-a-member' },
        { label: 'தன்னார்வ சேவை', href: '/volunteering' },
      ],
    },
    { label: 'தொடர்புகள்', href: '/contacts' },
  ],
  ABOUT: {
