...
// Photo list for a section's lightbox slider — the section's visible tiles.
function albumPhotos(section: (typeof IMAGES.gallerySections)[number]): Photo[] {
  return section.photos.map((p) => ({ src: p.src, alt: p.alt }))
}
      ...
      <div className="shell">
        ...
        {IMAGES.gallerySections.map((section, s) => (
          <div key={section.title} className={s === 0 ? 'mt-16' : 'mt-20'}>
            ...
            <div className="mt-8 grid auto-rows-[180px] grid-cols-2 gap-4 sm:auto-rows-[220px] sm:grid-cols-3 sm:gap-5 xl:auto-rows-[260px] 2xl:auto-rows-[300px] 3xl:auto-rows-[360px] 4xl:grid-cols-4 5xl:auto-rows-[440px] 5xl:gap-7">
