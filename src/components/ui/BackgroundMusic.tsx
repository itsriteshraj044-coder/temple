...
/**
 * Ambient temple music (no splash screen).
 *
 * Browsers block audible autoplay until the visitor interacts with the page,
 * so we start playback *muted* right away (always allowed) and unmute on the
 * first user gesture — a tap, click or key press anywhere — so the music
 * becomes audible the instant they touch the page. Nothing is persisted, so
 * it always restarts on refresh.
 */
